...
ActiveRecord::Schema.define(version: 20160421083024) do
  ...
  create_table "reservations_unapproved_resources", force: :cascade do |t|
    t.integer  "resource_id"
  ...
  add_index "reservations_unapproved_resources", ["reservation_id"], name: "index_reservations_unapproved_resources_on_reservation_id", using: :btree
  add_index "reservations_unapproved_resources", ["resource_id"], name: "index_reservations_unapproved_resources_on_resource_id", using: :btree
